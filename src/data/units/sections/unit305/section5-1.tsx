...
export const section5_1: Section = {
  ...
  description: "Understanding earthing principles and protective bonding requirements",
  content: (
    <div className="space-y-8">
      ...
      <div>
        <h3 className="text-xl font-semibold text-[#FFC900] mb-4">Principles of Earthing</h3>
        <p className="mb-4">
      ...
      <div>
        <h3 className="text-xl font-semibold text-[#FFC900] mb-4">Main Protective Bonding</h3>
        <p className="mb-4">
      ...
      <div>
        <h3 className="text-xl font-semibold text-[#FFC900] mb-4">Supplementary Bonding</h3>
        <p className="mb-4">
