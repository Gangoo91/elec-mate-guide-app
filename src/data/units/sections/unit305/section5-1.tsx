  ...
  content: (
    <>
      <ContentSection 
        ...
        content={
          <ul className="list-disc pl-6 space-y-1">
            <li>Understand the purpose and importance of main protective bonding</li>
            <li>Learn how to determine the correct size of main bonding conductors</li>
            <li>Know the proper installation requirements for bonding connections</li>
            <li>Understand testing requirements for main protective bonding</li>
          </ul>
        }
      />
      
      <ContentSection
        title="Main Protective Bonding Requirements" 
        content={<MainProtectiveBonding />}
      />
    </>
  )
};
