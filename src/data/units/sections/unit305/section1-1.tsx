...
export const section1_1: Section = {
  ...
  description: "Understanding the fundamental principles of electrical installation design",
  content: (
    <div className="space-y-8">
      ...
      <div>
        <h3 className="text-xl font-semibold text-[#FFC900] mb-4">Supply Arrangements</h3>
        <p className="mb-4">
      ...
      <div>
        <h3 className="text-xl font-semibold text-[#FFC900] mb-4">Circuit Design Considerations</h3>
