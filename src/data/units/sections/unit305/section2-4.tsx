  ...
  content: (
    <>
      <ContentSection 
        ...
        content={
          <ul className="list-disc pl-6 space-y-1">
            <li>Understand the IP rating system and its significance in electrical installations</li>
            <li>Interpret first and second digits in IP codes</li>
            <li>Select appropriate IP ratings for different installation environments</li>
            <li>Apply IP rating knowledge to ensure equipment suitability and durability</li>
          </ul>
        }
      />
      
      <ContentSection
        title="Ingress Protection Rating System" 
        content={<IPRatingsContent />}
      />
    </>
  )
};
