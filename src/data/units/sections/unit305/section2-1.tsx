...
export const section2_1: Section = {
  ...
  description: "Guidelines for selecting appropriate electrical equipment for installations",
  content: (
    <div className="space-y-8">
      ...
      <div>
        <h3 className="text-xl font-semibold text-[#FFC900] mb-4">Protective Devices</h3>
        <p className="mb-4">
      ...
      <div>
        <h3 className="text-xl font-semibold text-[#FFC900] mb-4">Cable Types and Selection</h3>
        <p className="mb-4">
      ...
      <div>
        <h3 className="text-xl font-semibold text-[#FFC900] mb-4">IP Ratings and Environmental Protection</h3>
        <p className="mb-4">
