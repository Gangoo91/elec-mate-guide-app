...
const EarthingConductorsSizing = () => {
  return (
  ...
  content: (
    <>
      <ContentSection 
        ...
        content={
          <ul className="list-disc pl-6 space-y-1">
            <li>Understand the purpose of different types of earthing conductors</li>
            <li>Learn how to determine the correct size of earthing conductors</li>
            <li>Apply the adiabatic equation for sizing conductors based on fault current</li>
            <li>Identify special considerations for earthing conductor installation</li>
          </ul>
        }
      />
      
      <ContentSection
        title="Earthing Conductor Sizing Requirements" 
        content={<EarthingConductorsSizing />}
      />
    </>
  )
};
