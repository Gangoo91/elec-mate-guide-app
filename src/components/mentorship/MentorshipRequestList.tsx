...
Request Date: ${new Date(request.requestDate).toLocaleDateString()}
  ...
  return (
    <>
                  ...
                  {request.status === "pending" ? (
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        variant="ghost"
                        size="icon"
                        onClick={() => setRequestToStop(request)}
      ...
      <AlertDialog open={!!requestToStop} onOpenChange={(open) => !open && setRequestToStop(null)}>
        <AlertDialogContent className="bg-[#22251e] border-[#FFC900]/20 text-[#FFC900]">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-[#FFC900]/80">
              Are you sure you want to stop mentoring {requestToStop?.apprenticeName}? This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
