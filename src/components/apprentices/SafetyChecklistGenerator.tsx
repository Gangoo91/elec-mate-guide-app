  ...
  const generateChecklist = async () => {
    ...
    try {
      ...
      if (data.checklist) {
        ...
        toast.success("Safety checklist generated successfully");
      } else {
    ...
    <div className="p-6">
      ...
      <div className="space-y-4">
        <p className="text-[#FFC900]/70">
          Generate comprehensive safety checklists for electrical installations based on the type of work.
        </p>

        <Textarea 
          placeholder="Enter installation type (e.g., domestic rewire, commercial installation, fire alarm system)..."
