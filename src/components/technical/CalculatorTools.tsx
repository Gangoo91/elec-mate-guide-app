  ...
  return (
    <div className="space-y-4">
      <Tabs defaultValue="ohms-law" className="w-full">
        ...
        <TabsContent value="voltage-drop" className="mt-4">
          <div className="space-y-6">
            <div className="text-2xl font-bold text-[#FFC900] mb-4">Voltage Drop Calculator</div>
        ...
        <TabsContent value="impedance" className="mt-4">
          <div className="space-y-6">
            <div className="text-2xl font-bold text-[#FFC900] mb-4">Earth Loop Impedance Calculator</div>
        ...
        <TabsContent value="instrumentation" className="mt-4">
          <div className="space-y-6">
            <div className="text-2xl font-bold text-[#FFC900] mb-4">Instrumentation Calculator</div>
