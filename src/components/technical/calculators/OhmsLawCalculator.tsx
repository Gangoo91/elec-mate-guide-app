  ...
  return (
    <div className="p-4 rounded-lg bg-[#22251e] border border-[#FFC900]/20">
      <Select value={solveFor} onValueChange={handleSolveForChange}>
        <SelectTrigger className="w-full mb-4 bg-[#22251e] border-[#FFC900]/20 text-[#FFC900]">
      ...
      <div className="space-y-3">
        ...
        <Button 
          ...
          className="w-full mt-2 bg-[#FFC900] text-black hover:bg-[#FFF200]"
        >
          Calculate
        </Button>

        {result && Object.keys(result).length > 0 && (
          <div className="mt-3 p-3 rounded-lg bg-[#22251e] border border-[#FFC900]/20">
            {result.voltage && (
        ...
        <div className="grid grid-cols-2 gap-3 mt-3">
          <div className="p-2 rounded-lg bg-[#22251e] border border-[#FFC900]/20">
