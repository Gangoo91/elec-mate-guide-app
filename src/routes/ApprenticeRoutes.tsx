...
export const ApprenticeRoutes = [
  ...
  <Route key="apprentices-level3-301-section" path="/apprentices/study-materials/city-guilds/level-3/301/:sectionId" element={<SectionPage />} />,
  <Route key="apprentices-level3-302-section" path="/apprentices/study-materials/city-guilds/level-3/302/:sectionId" element={<SectionPage />} />,
  <Route key="apprentices-level3-303-section" path="/apprentices/study-materials/city-guilds/level-3/303/:sectionId" element={<SectionPage />} />,
  <Route key="apprentices-level3-304-section" path="/apprentices/study-materials/city-guilds/level-3/304/:sectionId" element={<SectionPage />} />,
  <Route key="apprentices-level3-305-section" path="/apprentices/study-materials/city-guilds/level-3/305/:sectionId" element={<SectionPage />} />,
  <Route key="apprentices-level3-308-section" path="/apprentices/study-materials/city-guilds/level-3/308/:sectionId" element={<SectionPage />} />,
