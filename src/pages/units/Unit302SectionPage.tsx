...
const Unit302SectionPage = () => {
  ...
  const sectionKeys = Object.keys(sections302).sort();
          ...
          {isLastSection && (
            <div className="mt-8 pt-8 border-t border-[#FFC900]/20">
              ...
              <p className="text-[#FFC900]/80 mb-6">
                Now that you've completed all sections of Unit 302 on Principles of Electrical Science, 
                take this quiz to test your understanding of key concepts.
              </p>
              <SafetyQuiz unitId="302" timeLimit={300} />
            </div>
          )}
        </div>
      </div>
...
export default Unit302SectionPage;
