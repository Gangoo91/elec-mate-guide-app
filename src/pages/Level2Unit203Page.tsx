...
import { unit203 } from '@/data/units/unit203';
import { sections203 } from '@/data/units/sections/unit203Sections';
import { BookOpen, CheckCircle } from "lucide-react";

const Level2Unit203Page = () => {
  const navigate = useNavigate();
  
  const handleSectionClick = (sectionId: string) => {
    navigate(`/apprentices/study-materials/city-guilds/level-2/core-units/203/${sectionId}`);
  };
  ...
  return (
    <MainLayout>
      <div className="container px-4 py-2 md:py-4 pt-16 md:pt-16">
        <PageHeader 
          title={`Unit 203 - ${unit203.title}`}
          description={unit203.description || ''}
        ...
        <div className="mt-8 bg-[#22251e] border border-[#FFC900]/20 rounded-lg p-6">
          ...
          <div className="space-y-4">
            {Object.entries(sections203).sort().map(([sectionId, section]) => (
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[#FFC900]/70 text-sm">{section.description || 'Learn about electrical installation components and technology'}</p>
                      </div>
                    </div>
                    <Button 
          ...
          <div className="mt-8 flex flex-col md:flex-row items-center justify-between gap-4 p-4 bg-[#353a2c] rounded-lg border border-[#FFC900]/20">
            ...
            <Button
              ...
              onClick={() => navigate('/apprentices/study-materials/city-guilds/level-2/core-units/203/1.2')}
            >
              Take Unit Quiz
            </Button>
          </div>
...
export default Level2Unit203Page;
