...
import { BookOpen, GraduationCap, Award, ListCheck } from "lucide-react";
      ...
      <div className="container px-4 py-6 md:py-8 pt-16 md:pt-20">
        ...
        <Tabs defaultValue="nvq2" className="space-y-6">
          <TabsList className="bg-[#22251e] border-[#FFC900]/20">
            ...
            <TabsTrigger value="am2" className="text-[#FFC900] data-[state=active]:bg-[#FFC900] data-[state=active]:text-black">
              AM2
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="nvq3" className="space-y-4">
            <Card className="bg-[#22251e] border-[#FFC900]/20">
              <CardHeader>
                <CardTitle className="text-[#FFC900] flex items-center gap-2">
                  <GraduationCap className="h-5 w-5" />
                  NVQ Level 3 Advanced Electrical Installation
                </CardTitle>
              </CardHeader>
              <CardContent>
                <Accordion type="single" collapsible className="text-[#FFC900]">
          ...
          <TabsContent value="am2" className="space-y-4">
            <Card className="bg-[#22251e] border-[#FFC900]/20">
              <CardHeader>
                <CardTitle className="text-[#FFC900] flex items-center gap-2">
              ...
              <CardContent>
                <Accordion type="single" collapsible className="text-[#FFC900]">
                  <AccordionItem value="practical-tasks">
                    <AccordionTrigger>Practical Assessment Tasks</AccordionTrigger>
                    <AccordionContent className="text-[#FFC900]/80">
                      <ul className="list-disc list-inside space-y-2">
                  ...
                  <AccordionItem value="prep-resources">
                    <AccordionTrigger>Preparation Resources</AccordionTrigger>
                    <AccordionContent className="text-[#FFC900]/80">
                      <ul className="list-disc list-inside space-y-2">
