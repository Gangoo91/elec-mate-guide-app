      ...
      <div className="container px-4 py-2 md:py-4 pt-16 md:pt-16">
        ...
        <div className="mt-8 bg-[#22251e] border border-[#FFC900]/20 rounded-lg p-6">
          ...
          <div className="space-y-4">
            {Object.entries(sections201).sort().map(([sectionId, section]) => (
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[#FFC900]/70 text-sm">{section.description || 'Learn about health and safety principles'}</p>
                      </div>
                    </div>
                    <Button 
          ...
          <div className="mt-8 flex flex-col md:flex-row items-center justify-between gap-4 p-4 bg-[#353a2c] rounded-lg border border-[#FFC900]/20">
            ...
            <Button
              ...
              onClick={() => navigate('/apprentices/study-materials/city-guilds/level-2/core-units/201/1.1')}
            >
              Take Unit Quiz
            </Button>
          </div>
