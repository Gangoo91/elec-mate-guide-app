...
const PowerDistributionPage = () => {
  ...
  const navigateToSection = (section: string) => {
    navigate(`/apprentices/study-materials/city-guilds/moet/core-knowledge/electrical-principles/power-systems/distribution/${section}`);
  };
    ...
    <MainLayout>
      <div className="container px-4 py-2 md:py-4 pt-16 md:pt-16">
        ...
        <div className="mt-8 space-y-8">
          <div onClick={() => navigateToSection('networks')} className="cursor-pointer hover:opacity-80 transition-opacity">
          ...
          <div onClick={() => navigateToSection('smart-grid')} className="cursor-pointer hover:opacity-80 transition-opacity">
