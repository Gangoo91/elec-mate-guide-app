...
const PowerTransmissionPage = () => {
  ...
  const navigateToSection = (section: string) => {
    navigate(`/apprentices/study-materials/city-guilds/moet/core-knowledge/electrical-principles/power-systems/transmission/${section}`);
  };
    ...
    <MainLayout>
      <div className="container px-4 py-2 md:py-4 pt-16 md:pt-16">
        ...
        <div className="mt-8 space-y-8">
          <div onClick={() => navigateToSection('systems')} className="cursor-pointer hover:opacity-80 transition-opacity">
          ...
          <div onClick={() => navigateToSection('transformers')} className="cursor-pointer hover:opacity-80 transition-opacity">
          ...
          <div onClick={() => navigateToSection('infrastructure')} className="cursor-pointer hover:opacity-80 transition-opacity">
