...
import { professionalConductSections } from "@/data/moet/professionalConductSections";

const ProfessionalConductSectionPage = () => {
  ...
  const section = professionalConductSections.find(s => s.id === sectionId);
...
export default ProfessionalConductSectionPage;
