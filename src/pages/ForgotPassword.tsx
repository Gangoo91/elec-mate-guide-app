  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#151812] px-2">
      <div className="w-full max-w-md bg-transparent flex flex-col items-center relative animate-fade-in">
        ...
        <h1 className="text-3xl sm:text-4xl font-extrabold text-[#FFC900] text-center mb-4 mt-6 leading-tight drop-shadow-[0_0_8px_rgba(255,201,0,0.75)] tracking-wide select-none">
          Reset Password
        </h1>
